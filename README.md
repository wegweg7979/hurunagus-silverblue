...
Declarative, Atomic, immutable linux system. Built from atomic fedora, specifically a customized silverblue, withe the cachyOS kernel. Contains software choices for all types of computing.
