...
Declarative, Atomic, immutable linux system. Built from atomic fedora, specifically a customized silverblue for my use only. Contains software choices for all types of computing. ITS JUST SILVERBLUE PLUS SOME APPS.
